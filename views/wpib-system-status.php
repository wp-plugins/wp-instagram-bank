			...
			<div class="layout-span12">
				<div class="widget-layout wpib-body-background">
					<div class="widget-layout-title">
						<h4>
							<?php _e("Wp-Instagram System Status", instagram_bank); ?>
						</h4>
					</div>
					<div class="widget-layout-body">
						<a class="btn btn-success system-report" href="#"><?php _e("Get System Report", instagram_bank); ?></a>
						<div id="wp-insta-system-report" class="layout-system-report">
							<textarea readonly="readonly"></textarea>
						</div>
						<a class="btn btn-success close-report" href="#"><?php _e("Close System Report", instagram_bank); ?></a>
												...
												<span>
													...
													foreach ($active_plugins as $plugin) {
														...
														if (!empty($plugin_data["Name"])) {
															...
															if (strstr($dirname, instagram_bank)) {
